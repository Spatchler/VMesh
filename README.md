...
Install dependencies with your systems package manager e.g. `# pacman -S glm stb assimp` and they should work straight away since the premake config includes from `/usr/include` and shared objects should be linked by the os
